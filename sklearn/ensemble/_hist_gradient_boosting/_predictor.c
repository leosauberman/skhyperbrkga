 ...
 *         const X_DTYPE_C [:, :] numeric_data,
 */
  __pyx_tuple__22 = PyTuple_Pack(8, __pyx_n_s_nodes, __pyx_n_s_numeric_data, __pyx_n_s_raw_left_cat_bitsets, __pyx_n_s_known_cat_bitsets, __pyx_n_s_f_idx_map, __pyx_n_s_n_threads, __pyx_n_s_out, __pyx_n_s_i); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(7, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sklearn_ensemble__hist_gradient, __pyx_n_s_predict_from_raw_data, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 19, __pyx_L1_error)
