 ...
 *         grower,
 */
  __pyx_tuple__22 = PyTuple_Pack(11, __pyx_n_s_raw_predictions, __pyx_n_s_grower, __pyx_n_s_n_threads, __pyx_n_s_starts, __pyx_n_s_stops, __pyx_n_s_values, __pyx_n_s_partition, __pyx_n_s_leaves, __pyx_n_s_leaf, __pyx_n_s_leaf, __pyx_n_s_leaf); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 11, __pyx_L1_error)
