 ...
 *                  const unsigned char missing_values_bin_idx,
 */
  __pyx_tuple__22 = PyTuple_Pack(6, __pyx_n_s_data, __pyx_n_s_binning_thresholds, __pyx_n_s_missing_values_bin_idx, __pyx_n_s_n_threads, __pyx_n_s_binned, __pyx_n_s_feature_idx); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(5, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sklearn_ensemble__hist_gradient, __pyx_n_s_map_to_bins, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 13, __pyx_L1_error)
